...
cmd(
  ...
  async (
    ...
    try {
      ...
      const header = `VEXTER-MD WALLPAPER DOWNLOADER`;

      await conn.sendMessage(
        from,
        {
          image: {
            url: "https://i.ibb.co/nM0qZzx6/23d08aa6-1288-42a6-b705-a8b1e830487a.png",
          },
          caption: header,
        },
        { quoted: mek }
...
`;
      ...
      return reply("*🌟 Enjoy your HD wallpapers! Thank you for using VEXTER-MD.*");
    } catch (e) {
      console.error(e);
